...
export default function Rental({ properties, filters }: Props) {
    return (
        <AppLayout title="Rental Properties">
            <div className="min-h-screen bg-gray-50">
                <Head title="Rental Properties" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">
                            {properties.total} rental properties available
                        </p>
                    </div>
