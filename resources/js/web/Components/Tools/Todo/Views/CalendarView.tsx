            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={handleToday}
                            className="text-sm font-medium text-gray-700 hover:text-black px-2"
                        >
                            Today
                        </button>
                        <button
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                    <button className="hover:text-gray-800"> Weeks </button>
                    <div className="h-4 w-px bg-gray-300"> </div>
                    <button className="hover:text-gray-800"> Filter </button>
                    <div className="h-4 w-px bg-gray-300"> </div>
                    <button className="hover:text-gray-800"> Options </button>
                </div>
            </div>
