...
export default function BoardView({
    ...
    const onDragEnd = (result: DropResult) => {
        ...
        if (typeof onMoveTask === "function") {
            ...
            console.warn(
                "BoardView: onMoveTask prop is missing or not a function, using onUpdateTask fallback",
            );
    ...
    return (
        ...
        >
            ...
            {isEditing ? (
                ...
                <div
                    className={`text-sm font-medium text-gray-800 mb-2 cursor-pointer hover:text-blue-600 min-h-[20px] ${
