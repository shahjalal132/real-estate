...
export default function DashboardView({ tasks }: DashboardViewProps) {
    ...
    tasks.forEach((t) => {
        if (t.status === "recently_assigned")
            sectionCounts["Recently assigned"]++;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-gray-500 text-xs uppercase tracking-wider font-semibold">
                            {" "}
                    ...
                    <div className="flex justify-between items-center mt-4 border-t border-gray-100 pt-3">
                        ...
                        <button className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded hover:bg-gray-200">
                            {" "}
                            See all{" "}
                        </button>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                        <h3 className="text-gray-500 text-xs uppercase tracking-wider font-semibold">
                            {" "}
                            Tasks by completion status this upcoming month{" "}
                        </h3>
                    </div>
