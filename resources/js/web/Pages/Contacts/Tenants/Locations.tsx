                ...
                <div className="mx-auto max-w-[1920px] px-4 sm:px-6 lg:px-8 py-4">
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {locations.data.map((location) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            {formatDate(location.commencement)}
                                        </td>
                                        <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            {formatDate(location.expiration)}
                                        </td>
                                        <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            {formatPercent(
                                        ...
                                        <td className="px-4 py-4 text-right text-sm text-gray-500 whitespace-nowrap">
                                            {formatSF(location.sf_per_employee)}
                                        </td>
                                        <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            {location.industry || "—"}
                                        </td>
                                        ...
                                        <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            {formatDate(location.future_move)}
                                        </td>
                                        <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                    ...
                    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                        <div className="flex flex-1 justify-between sm:hidden">
                            <button
                                onClick={() => {
                                    if (locations.prev_page_url) {
                                        router.get(locations.prev_page_url);
                                    }
                                }}
                            ...
                            <button
                                onClick={() => {
                                    if (locations.next_page_url) {
                                        router.get(locations.next_page_url);
                                    }
                                }}
