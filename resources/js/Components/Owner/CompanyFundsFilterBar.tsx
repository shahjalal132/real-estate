...
interface CompanyFundsFilterBarProps {
    searchValue?: string;
...
const SORT_OPTIONS = [
    ...
    { value: "portfolio_size_sf", label: "Portfolio Size (SF)" },
];

export default function CompanyFundsFilterBar({
    searchValue = "",
    onSearchChange,
    onSearch,
    fundsCount = 0,
        ...
        <div className="border-b border-gray-200 bg-white">
            <div className="mx-auto max-w-[1920px] px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between gap-4 py-4">
                    ...
                    {/* Right Side - Fund Count and Sort */}
