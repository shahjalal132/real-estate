...
interface TenantContactsFiltersProps {
    tenantName?: string;
    hqLocation?: string;
...
export default function TenantContactsFilters({
    tenantName = "",
    hqLocation = "",
    contactsByRole = "",
    onTenantNameChange,
            ...
            <div>
                ...
                <div className="relative">
                    <select
                        ...
                        onChange={(e) => onContactsByRoleChange?.(e.target.value)}
