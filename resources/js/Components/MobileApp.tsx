            ...
            <div className="w-[95%] max-w-full mx-auto px-4 sm:px-6 lg:px-2">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg text-[#666666] mb-4 uppercase">
                            FIND YOUR NEXT INVESTMENT FROM ANYWHERE
                        </p>
                        <p className="text-[#666666] mb-6">
                            Discover a better way to buy and sell commercial
                            real estate with the new Marketplace app, brought to
                            you by the leading real estate platform.
                        </p>
                        <ul className="space-y-3 mb-8">
                            {features.map((feature, idx) => (
                                <li key={idx} className="flex items-start">
                                    <svg
                                        className="w-5 h-5 text-[#0066CC] mr-3 mt-0.5 flex-shrink-0"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
                                        <path
