...
className = {`flex flex-col items-center justify-center px-2 py-1 rounded-md transition-colors ${viewMode === "list"
        ? "text-blue-600"
...
className = {`flex flex-col items-center justify-center px-2 py-1 rounded-md transition-colors ${viewMode === "gallery"
        ? "text-blue-600"
        : "text-gray-400 hover:text-gray-600"
    }`}
                            >
