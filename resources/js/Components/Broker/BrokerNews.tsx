...
export default function BrokerNews() {
    ...
    <div className="flex justify-between items-center border-b border-gray-200 pb-4" >
        <div className="flex flex-col gap-y-2" >
            <div className="flex flex-col gap-y-1 font-serif text-base font-bold" >
                <div>
                By < span className = "text-[#0559B3]" > Andria Cheng </span>
                    </div>
                    < span className = "font-sans text-sm font-normal text-gray-700" > CoStar News </span>
                        </div>
                        < div className = "font-serif text-base font-normal" >
                            January 6, 2026 | 3: 52 P.M.
                                                    </div>
                                </div>
    ...
    100 Park, between 40th and 41st streets, recently renovated its amenity center on the second floor to include a lounge, golf simulator, game room, personal training studio and conference rooms, SL Green and Rockpoint said.Major tenants include global information services company AlphaSights, which signed a 10 - year lease for 192, 630 square feet in March 2022, and corporate turnaround and restructuring firm Alvarez & Marsal Holdings, which signed a 15 - year lease for 220, 221 square feet in December 2024, they said.
        ...
        <p>
                                                    Asking rent in the Grand Central market, where the property sits, has reached a record high of $82.14 per square foot, above New York metro’s average of $60, according to a < a href = "#" className = "text-blue-600 underline" > CoStar analysis.</a>
        </p>
        <p>
        ...
        <p>
                                                    The firm isn’t just a buyer in Manhattan office space.It’s also < a href = "#" className = "text-blue-600 underline" >in the process of selling </a> One Dag Hammarskjöld Plaza by the United Nations headquarters complex at about half of what it had paid for just before the pandemic in 2019.
        </p>
        < h3 className = "text-xl font-bold mt-6 mb-2" > For the record </h3>
            <p>
    ...
    <div className="border-t border-gray-200 pt-6 mt-8" >
        <div className="flex flex-col items-center" >
            <b className="mb-4" > Follow us on Social Media </b>
                < div className = "flex gap-4" >
                    <a href="#" className = "p-2 bg-gray-100 rounded-full hover:bg-blue-50" >
                                    ...
                                    < a href = "#" className = "p-2 bg-gray-100 rounded-full hover:bg-blue-50" >
                                        <Linkedin className="text-blue-700 w-8 h-8" />
                                            ...
                                            < div className = "mt-4 text-center" >
                                                <b>Have feedback or questions ? Email us at < a href = "mailto:news@costar.com" className = "text-blue-600 hover:underline" > news@costar.com</a></b >
                                                    </div>
                                                    </div>
                                                    </div>
                                                    </div>
            ...
            < div className = "flex flex-col" >
                <div className="mb-4 flex flex-col" >
                    <div className="m-0 mb-2 flex h-7 flex-row items-center justify-between" >
                        <h3 className="text-base font-sans font-bold leading-9 uppercase text-gray-900 border-b-2 border-transparent" > RELATED ARTICLES </h3>
                            </div>
                            < hr className = "m-0 border-x-0 border-b-0 border-solid border-neutral/50" />
                                ...
                                <ul className="list-none p-0 m-0" >
                                    <li className="mb-4 pb-4 border-b border-gray-200" >
                                        <a className="hover:text-blue-600 cursor-pointer font-serif text-[16px] leading-normal block" href = "#" >
                                            Miami's newest downtown office skyscraper refinanced in one of South Florida's biggest deals this year
                                                </a>
                                                </li>
                                                < li className = "mb-4 pb-4 border-b border-gray-200" >
                                                    <a className="hover:text-blue-600 cursor-pointer font-serif text-[16px] leading-normal block" href = "#" >
                                                        Olmstead Properties makes first Manhattan office purchase in a decade
                                                            </a>
                                                            </li>
                                                            < li className = "mb-4 pb-4 border-b border-gray-200" >
                                                                <a className="hover:text-blue-600 cursor-pointer font-serif text-[16px] leading-normal block" href = "#" >
                                                                    RXR sells Standard Motors Products Building in Long Island City, New York
                                                                        </a>
                                                                        </li>
                                                                        < li className = "mb-4 pb-4 border-b border-gray-200" >
                                                                            <a className="hover:text-blue-600 cursor-pointer font-serif text-[16px] leading-normal block" href = "#" >
                                                                                Office - to - residential project connected to Pfizer's former Manhattan home lands financing
                                                                                    </a>
                                                                                    </li>
                                                                                    < li >
                                                                                    <a className="hover:text-blue-600 cursor-pointer font-serif text-[16px] leading-normal block" href = "#" >
                                                                                        Morgan Properties pays $501 million for apartments in year's largest US multifamily deal
                                                                                            </a>
                                                                                            </li>
                                                                                            </ul>
                                                                                            </div>
    ...
    <div className="flex flex-col lg:sticky lg:top-6" >
        <div className="mb-4 flex flex-col" >
            <div className="m-0 mb-2 flex h-7 flex-row items-center justify-between" >
                <h3 className="text-base font-sans font-bold leading-9 uppercase text-gray-900" > IN THIS ARTICLE </h3>
                    </div>
                    < hr className = "m-0 border-x-0 border-b-0 border-solid border-neutral/50" />
                        </div>
                        < div >
                        <ul className="list-none p-0 m-0 space-y-4" >
                            ...
                            < li >
                            <div className="mb-4" >
                                <span className="mb-2 block font-sans text-base font-bold leading-6" > Properties </span>
                                    < ul >
                                    <li className="mb-2" >
                                        <div>
                                        <a className="text-blue-600 hover:underline text-base font-normal font-sans block" href = "#" > The Emporis Building </a>
                                            < p className = "m-0 font-sans text-sm text-gray-600" > 100 Park Ave, New York, NY </p>
                                                </div>
                                                </li>
                                                </ul>
                                                </div>
    ...
    <li>
        <div className="mb-4" >
            <span className="mb-2 block font-sans text-base font-bold leading-6" > Companies </span>
                < ul >
                <li className="mb-2" >
                    <div>
                    <a className="text-blue-600 hover:underline text-base font-normal font-sans block" href = "#" > SL Green Realty Corp.</a>
                        < p className = "m-0 font-sans text-sm text-gray-600" > Real Estate </p>
                            </div>
                            </li>
                            < li className = "mb-2" >
                                <div>
                                <a className="text-blue-600 hover:underline text-base font-normal font-sans block" href = "#" > Rockpoint </a>
                                    < p className = "m-0 font-sans text-sm text-gray-600" > Real Estate </p>
                                        </div>
                                        </li>
                                        </ul>
    ...
    <li>
        <div className="mb-4" >
            <span className="mb-2 block font-sans text-base font-bold leading-6" > Contacts </span>
                < ul >
                <li className="mb-2" >
                    <div>
                    <a className="text-blue-600 hover:underline text-base font-normal font-sans block" href = "#" > Adam Spies </a>
                        < p className = "m-0 font-sans text-sm text-gray-600" > Co - Head of U.S.Capital Markets, Newmark </p>
                            </div>
                            </li>
                            < li className = "mb-2" >
                                <div>
                                <a className="text-blue-600 hover:underline text-base font-normal font-sans block" href = "#" > Douglas Harmon </a>
                                    < p className = "m-0 font-sans text-sm text-gray-600" > Co - Head of U.S.Capital Markets, Newmark </p>
                                        </div>
                                        </li>
                                        </ul>
    ...
    <div className="border-t border-gray-200 bg-gray-50 py-6 px-4" >
        <div className="max-w-[1290px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4" >
            <div className="flex items-center gap-6" >
                <div className="text-2xl font-bold italic tracking-tighter text-blue-900" > CoStar </div>
                    < div className = "flex gap-6 text-sm text-gray-600" >
                        <a href="#" className = "hover:text-blue-600 hover:underline" > Help with Features </a>
                        < a href = "#" className = "hover:text-blue-600 hover:underline" > Request Training </a>
                            < a href = "#" className = "hover:text-blue-600 hover:underline" > Share Feedback </a>
                                </div>
                                </div>
                                < div className = "flex items-center gap-4 text-sm text-gray-500" >
                                    <span>© 2026 CoStar Group.All rights reserved.</span>
                                        < a href = "#" className = "hover:text-blue-600 hover:underline" > Terms of Use </a>
                                            </div>
                                            </div>
                                            </div>
                                            </div>
